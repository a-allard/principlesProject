...
# Borrowed  from :https://github.com/chjohnkim/ur10_motion_script/blob/master/src/ur10_motion_script.py
...
gripper_publisher = rospy.Publisher('Robotiq2FGripperRobotOutput', outputMsg)
