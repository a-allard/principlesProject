...
def gripper_on():
    ...
    rospy.wait_for_service('/ur10/vacuum_gripper/on')
    try:
...
def gripper1_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper1/on')
    try:
        # Create a handle for the calling the srv
...
def gripper2_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper2/on')
    try:
        # Create a handle for the calling the srv
...
def gripper3_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper3/on')
    try:
        # Create a handle for the calling the srv
...
def gripper4_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper4/on')
    try:
        # Create a handle for the calling the srv
...
def gripper5_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper5/on')
    try:
        # Create a handle for the calling the srv
...
def gripper6_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper6/on')
    try:
        # Create a handle for the calling the srv
...
def gripper7_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper7/on')
    try:
        # Create a handle for the calling the srv
...
def gripper8_on():
    # Wait till the srv is available
    rospy.wait_for_service('/ur10/vacuum_gripper8/on')
    try:
        # Create a handle for the calling the srv
...
def gripper_off():
    rospy.wait_for_service('/ur10/vacuum_gripper/off')
    try:
...
def gripper2_off():
    rospy.wait_for_service('/ur10/vacuum_gripper2/off')
    try:
...
def gripper3_off():
    rospy.wait_for_service('/ur10/vacuum_gripper3/off')
    try:
...
def gripper4_off():
    rospy.wait_for_service('/ur10/vacuum_gripper4/off')
    try:
...
def gripper5_off():
    rospy.wait_for_service('/ur10/vacuum_gripper5/off')
    try:
...
def gripper6_off():
    rospy.wait_for_service('/ur10/vacuum_gripper6/off')
    try:
...
def gripper7_off():
    rospy.wait_for_service('/ur10/vacuum_gripper7/off')
    try:
...
def gripper8_off():
    rospy.wait_for_service('/ur10/vacuum_gripper8/off')
    try:
...
gripper_status_sub = rospy.Subscriber('/ur10/vacuum_gripper/grasping', Bool, gripper_status, queue_size=1)
